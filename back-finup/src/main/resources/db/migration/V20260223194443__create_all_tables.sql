...
CREATE TABLE IF NOT EXISTS transacao (
    ...
    KEY fk_transacao_tipo_pagamento_idx (tipo_pagamento_id),
    KEY fk_transacao_tipo_gasto_idx (tipo_gasto_id),
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT fk_transacao_tipo_pagamento
    FOREIGN KEY (tipo_pagamento_id)
    REFERENCES tipo_pagamento (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT fk_transacao_tipo_gasto
